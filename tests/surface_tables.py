...
PARAMETERS: dict[str, set[str]] = {
    ...
    "POST computers/:id/executions/:executionId/retained-output": {
        "body:max_bytes_per_stream",
        "body:retention_seconds",
    },
    "GET computers/:id/results/:resultId": set(),
    "GET computers/:id/results/:resultId/output": {"query:stream", "query:offset", "query:limit"},
    "DELETE computers/:id/results/:resultId": set(),
    "POST computers/:id/artifacts": {
        "body:path",
        "body:expected_size",
    ...
    "GET computers/:id/artifacts/:artifactId": set(),
    "GET computers/:id/artifacts/:artifactId/download": set(),
    "DELETE computers/:id/artifacts/:artifactId": set(),
    "POST computers/:id/windows/:window": {
        "body:action",
        "body:x",
        "body:y",
